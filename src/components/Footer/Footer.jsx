...
function Footer() {
  ...
  async function fetchSubscribe() {
    ...
    if(!response.ok) {
      dispatch(setError('Ошибка' + response.statusText));
    } else {
      setEmail('Успех!');
    }
  }
  ...
  function errorCheck() {
    if(email === '') {
      ...
      setEmailError('Указан некорректный Email Пример: inbox@gmail.ru');
      return false;
    }
    return true;
  }
    ...
    <footer className='footer'>
      <div className='footer-container'>
        <div className='contacts' id='contacts'>
          ...
          <ul>
            <li>
              <img className='contacts-icon' src='./src/svg/phone.svg'></img>
              <span>8 (800) 000 00 00</span>
            </li>
            <li>
              <img className='contacts-icon' src='./src/svg/mail.svg'></img>
              <a href='inbox@mail.ru'>inbox@mail.ru</a>
            </li>
            <li>
              <img className='contacts-icon' src='./src/svg/skype.svg'></img>
              <a href='tu.train.tickets'>tu.train.tickets</a>
            </li>
            <li>
              <img className='contacts-icon' src='./src/svg/location.svg'></img>
              <span>
                г. Москва <br></br>
        ...
        <div className='subscribe-container'>
          ...
          <label htmlFor="mail">Будьте в курсе событий</label>
          <form className='subscribe-form'>
            <input className={emailError? 'sfi-error' : ''} type="text" placeholder='e-mail' name="mail" id="mail" onChange={(e) => setEmail(e.target.value)} value={email}></input>
            <button type="submit" onClick={(e) => onSubscribe(e)}>ОТПРАВИТЬ</button>
          </form>
      ...
      <div className='footer-basement'>
        ...
        <span className='version'>2018 WEB</span>
      </div>
    </footer>
  )
}
